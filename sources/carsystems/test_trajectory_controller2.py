...
from libs.TrajectoryController2 import TrajectroryController
...
if __name__ == '__main__':
    ...
    traj_point = OnlyPoint(Point(-2, -1))
    ...
    while True:
        try:
            ...
            v_des, omega_des = trajectory_controller.getControls(point, x, y, theta * pi / 180, 0.2, 0.0, 0.0, dt)
