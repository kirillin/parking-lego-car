    ...
    def move(self, vel_linear=None, vel_angular=None, trajectory=None, mapping=None):
        ...
        while True:
            try:
                ...
                x, y, vx, vy = self.__localization.getData(theta * pi / 180, self.__motor_rear.speed * pi / 180, dt)

                if trajectory is not None:
                    point = trajectory.getCoordinates(t)
                    v_des, omega_des = self.__trajectory_controller.getControls(point, x, y, vx, vy, theta * pi / 180, dt)
